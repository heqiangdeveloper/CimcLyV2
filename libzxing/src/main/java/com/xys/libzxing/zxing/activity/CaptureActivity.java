...
public final class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private de.hdodenhof.circleimageview.CircleImageView btn;
    ...
    public void onCreate(Bundle icicle) {
        ...
        btn = (de.hdodenhof.circleimageview.CircleImageView) findViewById(R.id.imgbutton);
    ...
    private void cameraFlashControl() {
        ...
        try{
            if (cameraManager.flashControlHandler()) {
                ...
                btn.setImageResource(R.mipmap.light_on);
            } else {
                //cameraFlashControl.setImageResource(R.drawable.qrcode_scan_btn_flash_nor);
                btn.setImageResource(R.mipmap.light_off);
            }
        }catch (Exception e){
            btn.setImageResource(R.mipmap.light_off);
            Toast.makeText(CaptureActivity.this,"打开闪光灯失败，请稍后再试",Toast.LENGTH_SHORT).show();
        }
    }
