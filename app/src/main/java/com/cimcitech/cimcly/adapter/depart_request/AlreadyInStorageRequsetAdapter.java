...
public class AlreadyInStorageRequsetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AlreadyInStorageRequsetAdapter(Context context, List<WaitInStorageInfo> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View view = inflater.inflate(R.layout.already_in_storage_request_item_view, parent, false);
