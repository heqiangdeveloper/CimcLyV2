package com.cimcitech.cimcly.adapter.depart_request;
...
public class AlreadyRequsetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AlreadyRequsetAdapter(Context context, List<WaitInStorageInfo> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View view = inflater.inflate(R.layout.already_request_item_view, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            /*((ItemViewHolder) holder).ckBox.setOnCheckedChangeListener(new CompoundButton
