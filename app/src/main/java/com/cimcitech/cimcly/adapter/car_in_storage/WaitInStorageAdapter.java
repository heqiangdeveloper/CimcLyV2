...
public class WaitInStorageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WaitInStorageAdapter(Context context, List<WaitInStorageInfo> data) {
