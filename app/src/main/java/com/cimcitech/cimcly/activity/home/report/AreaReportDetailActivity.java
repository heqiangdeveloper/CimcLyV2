...
import com.cimcitech.cimcly.bean.report.AreaOpportUnitReq;
...
public class AreaReportDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.status_bt:
                ...
                showContactUsPopWin(AreaReportDetailActivity.this, "选择订单状态查询", list);
    ...
    public void initViewData() {
        ...
        final LinearLayoutManager layoutManager = new LinearLayoutManager(AreaReportDetailActivity.this);
    ...
    public void getData() {
        String json = new Gson().toJson(new AreaOpportUnitReq(pageNum, 10, "",
                new AreaOpportUnitReq.AreaOpportUnityBean(REGION,
