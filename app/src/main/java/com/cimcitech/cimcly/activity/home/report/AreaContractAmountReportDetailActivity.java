...
public class AreaContractAmountReportDetailActivity extends AppCompatActivity implements View.OnClickListener {
    @Bind(R.id.status_bt)
    Button statusBt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_area_contract_report_detail2);
    ...
    public void initTitle(){
        ...
        titleName_Tv.setText("不同区域年度合同数统计明细");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.status_bt:
                ...
                showContactUsPopWin(AreaContractAmountReportDetailActivity.this, "选择订单状态查询", list);
    ...
    public void initViewData() {
        adapter = new AreaContractAmountDetailAdapter(AreaContractAmountReportDetailActivity.this, data);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        //防止FC:java.lang.IndexOutOfBoundsException: Inconsistency detected. Invalid item position 12(offset:12).state:26
                        adapter.notifyDataSetChanged();
                        data.clear(); //清除数据
                        pageNum = 1;
                        isLoading = false;
        ...
        final LinearLayoutManager layoutManager = new LinearLayoutManager(AreaContractAmountReportDetailActivity.this);
    ...
    public void getData() {
        ...
        String json = new Gson().toJson(new ContractReportDetailReq(pageNum, 10, "",
                new ContractReportDetailReq.ContOrderBean(YEAR,REGION,null,null,null,
