    ...
    public void getYear(){
        yearSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                selectYear = (String) yearSpinner.getSelectedItem();
                getData();
            }
    ...
    private void showTables(){
        ...
        barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                if(list != null && list.size() != 0){
                    Intent i = new Intent(AreaContractAmountReportActivity.this,
                            AreaContractAmountReportDetailActivity.class);
    ...
    private void showGrid(){
        ...
        if(list != null && list.size() != 0){
            for(int i = 0; i < list.size(); i++){
                ...
                ((TextView)linearLayout[i].getChildAt(0)).setText(list.get(i).getRegionDesc());//区域
