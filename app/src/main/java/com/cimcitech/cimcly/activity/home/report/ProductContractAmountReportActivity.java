...
public class ProductContractAmountReportActivity extends AppCompatActivity{
    @Bind(R.id.barChart)
    BarChart barChart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_report_product_contract_amount2);
    ...
    public void initTitle(){
        titleName_Tv.setText("不同产品年度合同数统计");
    ...
    private void showTables(){
        ...
        if(list != null && list.size() != 0){
            for(int i = 0; i < list.size(); i++){
                xValues.add(list.get(i).getProductVarietyDesc());
            }
        }
        ...
        barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                if(list != null && list.size() != 0){
                    Intent i = new Intent(ProductContractAmountReportActivity.this,ProductContractAmountReportDetailActivity
                            .class);
                    i.putExtra("productvariety",list.get(e.getXIndex()).getProductVariety());
    ...
    private void showGrid(){
        ...
        if(list != null && list.size() != 0){
            for(int i = 0; i < list.size(); i++){
                ...
                ((TextView)linearLayout[i].getChildAt(0)).setText(list.get(i).getProductVarietyDesc());
