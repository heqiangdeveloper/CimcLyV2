...
public class ProvinceTop10ReportDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.status_bt:
                ...
                showContactUsPopWin(ProvinceTop10ReportDetailActivity.this, "选择订单状态查询", list);
    ...
    public void initViewData() {
        ...
        final LinearLayoutManager layoutManager = new LinearLayoutManager(ProvinceTop10ReportDetailActivity.this);
    ...
    public void getData() {
        ...
        String json = new Gson().toJson(new ContractReportDetailReq(pageNum, 10, "",
                new ContractReportDetailReq.ContOrderBean(YEAR,null,null,null,PROVINCE,
