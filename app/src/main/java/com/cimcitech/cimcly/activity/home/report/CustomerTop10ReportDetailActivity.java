...
public class CustomerTop10ReportDetailActivity extends AppCompatActivity implements View.OnClickListener {
    @Bind(R.id.status_bt)
    Button statusBt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_top10_report_detail2);
    ...
    public void initTitle(){
        ...
        titleName_Tv.setText("合同总额前10的客户年度合同数统计明细");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.status_bt:
                ...
                showContactUsPopWin(CustomerTop10ReportDetailActivity.this, "选择订单状态查询", list);
    ...
    public void initViewData() {
        adapter = new AreaContractAmountDetailAdapter(CustomerTop10ReportDetailActivity.this, data);
        ...
        final LinearLayoutManager layoutManager = new LinearLayoutManager(CustomerTop10ReportDetailActivity.this);
    ...
    public void getData() {
        ...
        String json = new Gson().toJson(new ContractReportDetailReq(pageNum, 10, "",
                new ContractReportDetailReq.ContOrderBean(YEAR,null,null,CUSTID,null,
